...
const StackSection = () => {
  ...
  const StackCard = ({
    ...
    <Card
      className="bg-gradient-card border-border/50 backdrop-blur-sm hover:scale-105 transition-all duration-300 animate-fade-in"
    ...
    <section id="stack" className="py-20 px-4 sm:px-6 lg:px-8 relative">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <StackCard title={t.stack.frontend} items={frontendStack} delay={0} />
          <StackCard title={t.stack.backend} items={backendStack} delay={200} />
          <StackCard title={t.stack.tools} items={toolsStack} delay={400} />
        </div>
